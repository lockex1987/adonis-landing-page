...
"use strict";
/*!*******************************************!*\
  !*** ./frontend/js/pages/product-list.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
...
Vue.createApp({
  mounted: function mounted() {
    ...
    PubSub.subscribe('cart-items-changed', function (data) {
      _this.bindProductQuantity();
    });
  },
  methods: {
    bindProductQuantity: function bindProductQuantity() {
      var items = (0,_helpers_shopping_cart_js__WEBPACK_IMPORTED_MODULE_0__.getItems)();
      document.querySelectorAll('.product-quantity').forEach(function (spanTag) {
        var productId = parseInt(spanTag.dataset.productId);
        var obj = items.find(function (e) {
          return e.id == productId;
        });
    ...
    addToCartVue: function addToCartVue(productId) {
      var items = (0,_helpers_shopping_cart_js__WEBPACK_IMPORTED_MODULE_0__.increaseQuantity)(productId);
      var obj = items.find(function (e) {
        return e.id == productId;
      });
      var spanTag = document.querySelector('#productQuantity' + productId);
      spanTag.textContent = obj.quantity;
