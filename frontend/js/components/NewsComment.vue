    ...
    <div class="comments">
        ...
        <div v-show="checkLoginStatus == 1">
            ...
            <div>
                <button type="button"
                    ...
                    @click="addComment()">
                    Thêm bình luận
                    <span class="la la-spinner la-spin"
        ...
        <div v-for="comment in commentList"
            ...
            <div class="mb-3 d-flex align-items-center">
                ...
                <i class="fa fa-circle ms-3"
                    style="font-size: 0.25rem; color: #bdbdbd;"></i>
            ...
            <div v-show="checkLoginStatus == 1 && !comment.showReply"
                class="mt-3">
                <a href="#"
            ...
            <div class="border-start ps-5">
                <div v-show="comment.showReply"
                    ...
                    <div class="mb-3">
                        <html-editor :ref="'replyEditor' + comment.id"
